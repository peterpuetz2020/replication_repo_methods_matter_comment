...
res = xglue(meth.nostar.tpl, open="<<", close=">>")
writeLines(res, here("Results", "binom10_aer_omit.tex"))
res
...
res = xglue(meth.nostar.tpl, open="<<", close=">>")
writeLines(res, here("Results", "binom01_aer_omit.tex"))
res
