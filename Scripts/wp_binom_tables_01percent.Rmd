...
dat = readRDS(here("Data","deround_binom_01percent.Rds"))
...
# Two-sided Binominal tests using the 1% significance threshold z=2.576
...
writeLines(res, here("Results", "wp01_binom_all.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp01_binom_did.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp01_binom_iv.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp01_binom_rdd.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp01_binom_rct.tex"))
res
```
...
writeLines(res, here("Results", "wp01_binom_reported.tex"))
res
...
res = xglue(meth.tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp01_binom_omit.tex"))
res
