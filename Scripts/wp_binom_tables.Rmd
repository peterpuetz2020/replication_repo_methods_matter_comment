...
writeLines(res, here("Results", "wp_binom_all.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp_binom_did.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp_binom_iv.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp_binom_rdd.tex"))
res
```
...
res = xglue(tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp_binom_rct.tex"))
res
```
...
```{r results="asis"}
dat = filter(all.dat, mode=="reported")
res = xglue(meth.tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp_binom_reported.tex"))
res
...
res = xglue(meth.tpl, open="<<", close=">>")
writeLines(res, here("Results", "wp_binom_omit.tex"))
res
